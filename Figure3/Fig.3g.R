...
dir <-"/Users/yuanjingnan/Desktop/daily/20230602/figure-20230602/code/Figure3/Fig3g/"
nba <-  read.table(file = paste(dir,"Fig.3g.txt",sep = ""),sep = "\t") 

pdf(paste(dir,"Fibroblats.pdf",sep = ""),width=4, height=5)
P3 <- ggplot(nba, aes(Subtype_IE, as.numeric(CAF),color=Subtype_IE))+
  ...
  labs(title="",x="",y="Cancer-associated fibroblasts",size=25)+
  theme_bw()+
